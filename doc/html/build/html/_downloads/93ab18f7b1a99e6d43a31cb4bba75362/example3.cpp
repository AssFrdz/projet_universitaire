// Example that constructs three 8x8 discrete-time Markov chain
...
int main( int argc, char** argv ) 
{
    ...
    if (test)
    {
        ...
        std::cout << "## Displaying transient distributions at time " << n
                  << std::endl;
        ...
        std::cout << "## Destruction of initial and transient distributions" << std::endl;
        delete initial1;
        delete initial2;
        delete initial3;
        delete statTrans1;
        ...
        std::cout << "## Destruction of MCs" << std::endl;
        delete c1;
        delete c2;
        delete c3;

        return 0;  // Exit with OK code
    }
    else
    {
        std::cout << "Input format is not valid !!" << std::endl;
        std::cout << "Usage: " << argv[0]
                  << " <n> <p1> <p2> <p3> <p4> <p5> <p6> <p7> <p8>"
                  << std::endl;
        return -1; // Usage error returns an error
    }
